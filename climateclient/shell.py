...
VERSION = 1.0
CLIMATE_API_VERSION = '1'
COMMANDS = {CLIMATE_API_VERSION: COMMANDS_V1}
...
class ClimateShell(app.App):
    ...
    def authenticate_user(self):
        ...
        client = climate_client.Client(climate_url, keystone.auth_token)
        self.client = client
        return
...
def main(argv=sys.argv[1:]):
    try:
        return ClimateShell(CLIMATE_API_VERSION).run(map(strutils.safe_decode,
                                                         argv))
